...
// In /services/operations/profileAPI.jsx
...
export async function getInstructorData(token) {
  ...
  try {
    ...
    // It's good practice to check for success before accessing data
    if (!response?.data?.success) {
      throw new Error(response.data.message || "Could Not Get Instructor Data");
    }

    // --- THIS IS THE FIX ---
    // Access the 'data' property, which contains the array of courses with stats.
    result = response?.data?.data;
    // --- END OF FIX ---
