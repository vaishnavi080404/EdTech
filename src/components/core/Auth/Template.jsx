...
const Template = ({ title, desc1, desc2, image, formType,setIsLoggedIn }) => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // 2. Determine the accountType to send based on the formType
  ...
  return (
    // The main container is now transparent to show the animated background from the Login page
    <div className="flex items-center justify-center">
      <div className="flex flex-col lg:flex-row items-center w-full max-w-6xl px-4 py-10 gap-10 lg:gap-20">

        {/* Left Form Section - Styled as a "glassmorphism" card */}
        <div className="
        ...
        ">
          ...
          <p className="mt-2 text-base text-soft-terracotta/80">
            <span>{desc1} </span>
            <br />
            {/* Using the HighlightText component for the italicized description for brand consistency */}
        ...
        {/* Right Image Section */}
         <div className="relative w-11/12 max-w-[450px] hidden lg:block">
          ...
          {/* Main student image with a more dynamic position and hover effect */}
          <img
            src={image}
            alt="student"
            className="
