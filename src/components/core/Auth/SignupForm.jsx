...
function changeHandler(event) {
  ...
  dispatch(setSignupData(completeSignupData));
    ...
    // Store data temporarily for use in the OTP page (could be Redux or localStorage)
    localStorage.setItem("signupData", JSON.stringify({
      ...formData,
      accountType,
    }));

    // Send OTP and go to verify page
    dispatch(sendOtp(formData.email, navigate));
  }

  return (
    <div>
      {/* --- STYLED ACCOUNT TYPE TABS --- */}
      ...
      {/* Signup Form */}
      {/* Removed background and shadow to inherit from parent Template */}
      <form
...
//     <div>
//       {/* Account Type Tabs */}
//       <div className="flex bg-gray-800 p-1 gap-x-1 rounded-full max-w-max mb-6">
//         <button
//           onClick={() => setAccountType("Student")}
//           className={`${
//             accountType === "Student"
...
//       <form
//         onSubmit={submitHandler}
//         className="bg-[#0f172a] text-white p-8 rounded-xl shadow-lg w-full space-y-6"
//       >
...
//               placeholder="Enter first name"
//               value={formData.firstName}
//               className="w-full px-4 py-2 rounded-md bg-[#0f172a] text-white border border-gray-600 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
//             />
//           </label>
...
//           {/* Password */}
//           <label className="w-1/2 relative">
//             <p className="mb-1 text-sm font-medium">Create Password<sup className="text-red-500">*</sup></p>
//             <input
//               type={showPassword ? 'text' : 'password'}
//               required
//               name="password"
...
//             <span
//               onClick={() => setShowPassword((prev) => !prev)}
//               className="absolute top-9 right-3 text-gray-400 cursor-pointer hover:text-blue-500"
//             >
//               {showPassword ? <AiOutlineEyeInvisible size={22} /> : <AiOutlineEye size={22} />}
//             </span>
//           </label>
...
//         <button
//           type="submit"
//           className="w-full bg-yellow-400 hover:bg-blue-700 text-white py-2 rounded-md font-semibold text-lg transition"
//         >
//           Create Account
//         </button>
//       </form>
