...
const LoginForm = () => {
  ...
  return (
    ...
    // Removed the background and shadow to inherit from the parent Template component.
    <form
    ...
    >
      ...
      <label className="block">
        ...
        <input
          ...
          name="email"
          // Updated input field styling to match the brand
          className="
      ...
      <button
        type="submit"
        // Styled to match your primary CTAButton
        className="
...
//     <form
//       onSubmit={submitHandler}
//       className="bg-[#0f172a] text-white p-8 rounded-xl shadow-lg w-full max-w-md space-y-6"
//     >
//       {/* Email */}
//       <label className="block">
...
//           placeholder="Enter your email"
//           name="email"
//           className="w-full px-4 py-2 rounded-md bg-[#0f172a] text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400"
//         />
//       </label>
...
//           {showPassword ? <AiOutlineEyeInvisible size={22} /> : <AiOutlineEye size={22} />}
//         </span>
//         <Link to="/forgot-password" className="text-blue-400 text-sm hover:underline mt-1 inline-block">
//           Forgot Password?
//         </Link>
//       </label>
...
//       <button
//         type="submit"
//         className="w-full bg-yellow-400 hover:bg-blue-700 transition duration-200 text-white py-2 rounded-md font-semibold text-lg"
//       >
//         Sign In
//       </button>
//     </form>
