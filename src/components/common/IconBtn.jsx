...
//       onClick={onClick}
//       type={type}
//       className={`flex items-center gap-2 px-4 py-2 rounded-md font-medium text-white transition duration-200
//         ${outline ? "bg-transparent border border-yellow-400 text-yellow-400" : "bg-yellow-400 text-black"}
//         ${customClasses}
//         ${disabled ? "cursor-not-allowed opacity-50" : "hover:scale-95"}`}
//     >
//       {children ? (
//         <>
//           <span>{text}</span>
  ...
  return (
    <button
      ...
      className={`
        ...
        /* --- Conditional Styling for Primary vs. Outline Button --- */
        ${outline 
