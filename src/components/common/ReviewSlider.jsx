...
import Img from './Img'; // Your custom lazy-loading image component
...
export default function ReviewSlider() {
  ...
  // 2. DEFINE THE CUSTOM STYLES FOR THE NEW RATING COMPONENT
  const myStyles = {
    itemShapes: Star,
    activeFillColor: '#FFC700', // your 'golden-sunshine' color
    inactiveFillColor: 'rgba(255, 241, 240, 0.3)' // your semi-transparent 'soft-terracotta'
  }
            ...
            <SwiperSlide key={i}>
              <div className="flex h-full flex-col gap-3 bg-espresso-brown/80 p-4 text-sm text-soft-terracotta
                ...
                <div className="flex items-center gap-2 mt-auto">
                  ...
                  {/* --- 3. USE THE NEW, RELIABLE RATING COMPONENT --- */}
                  <Rating
                    value={review.rating}
                    readOnly={true} // Stars are for display, not interaction
                    style={{ maxWidth: 100 }}
                    itemStyles={myStyles} // Apply our custom brand colors
                  />
                </div>
              </div>
            </SwiperSlide>
