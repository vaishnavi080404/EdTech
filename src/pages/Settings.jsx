...
const Settings = () => {
   ...
   const handleDeleteAccount = () => {
     dispatch(deleteProfile(navigate)); // Dispatch the deleteProfile action
  ...
  return (
    ...
    <div className="text-soft-terracotta w-11/12 max-w-[1000px] mx-auto py-10">
      ...
      {/* --- STYLED PROFILE PICTURE SECTION --- */}
      ...
      {/* --- STYLED PROFILE INFORMATION FORM --- */}
      ...
      {/* --- STYLED CHANGE PASSWORD SECTION --- */}
      ...
      {/* --- STYLED DELETE ACCOUNT SECTION ("DANGER ZONE") --- */}
...
// import UpdateDisplayPicture from "../components/core/Dashboard/Settings/UpdateDisplayPiture";
// import { updateProfile, changePassword } from "../services/operations/authAPI";
// import { deleteProfile } from "../services/operations/authAPI"; // Import deleteProfile action
...
//   };
//   return (
//     <div className="text-white w-11/12 max-w-[1000px] mx-auto py-10">
//       <h1 className="text-3xl font-semibold mb-8">Edit Profile</h1>

//       <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
//         {/* Profile Image Section */}
//         <div>
//           <p className="mb-5 text-lg font-medium text-richblack-100">Change Profile Picture</p>
//           <div className="flex flex-col md:flex-row items-center gap-5 bg-richblack-800 p-4 rounded-md">
...
//         {/* Additional Fields (Example only, expand as needed) */}
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//           <div>
//             <label className="text-sm text-richblack-200">Date of Birth</label>
//             <input
//               type="date"
...
//           </div>
//           <div>
//             <label className="text-sm text-richblack-200">Gender</label>
//             <select
//               {...register("gender")}
//               className="w-full p-2 rounded bg-richblack-700 text-white"
//             >
...
//           </div>
//           <div>
//             <label className="text-sm text-richblack-200">Contact Number</label>
//             <input
//               type="text"
...
//           </div>
//           <div>
//             <label className="text-sm text-richblack-200">About</label>
//             <textarea
//               {...register("about")}
//               rows="3"
//               className="w-full p-2 rounded bg-richblack-700 text-white"
...
//             className="bg-richblack-600 px-4 py-2 rounded-md"
//           >
//             Cancel
//           </button>
//           <IconBtn type="submit" text="Save Changes" />
...
// <div className="mt-16 p-6 bg-richblack-800 rounded-md space-y-4">
...
//   >
//     <div className="col-span-2 md:col-span-1">
//       <label className="text-sm text-richblack-200">Current Password</label>
//       <input
//         type="password"
...
//     <div className="col-span-2 md:col-span-1">
//       <label className="text-sm text-richblack-200">New Password</label>
//       <input
//         type="password"
...
//     <div className="col-span-2">
//       <label className="text-sm text-richblack-200">Confirm New Password</label>
//       <input
//         type="password"
...
//       <div className="mt-16 p-6 bg-pink-800 rounded-md">
//         <h2 className="text-xl font-semibold text-white">Delete Account</h2>
//         <p className="text-sm text-richblack-300 my-2">
//           This action is permanent and cannot be undone. All your data
//           including purchased courses will be lost.
//         </p>
//         <button
