...
import { FaCog, FaRobot } from 'react-icons/fa'; // Icons for the scene
import CTAButton from '../components/core/HomePage/Button'; // Assuming your button is here

const Error = () => {
  return (
    // Main container with brand background and overflow hidden to contain animations
    <div className='flex items-center justify-center min-h-screen bg-soft-terracotta text-espresso-brown text-center px-4 overflow-hidden'>
      <div className="relative w-full max-w-lg">
        ...
        {/* These are decorative and positioned absolutely */}
