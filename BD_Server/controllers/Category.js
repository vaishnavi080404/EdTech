...
//         return res.status(200).json({ // <-- Change status to 200
//             success: true, // <-- Change success to true
//             message: "No courses found for the selected category.",
//             data: {
//                 selectedCategory: selectedCategory, // Send back the category info anyway
//                 differentCategory: null, // You can decide what to send here
//                 mostSellingCourses: [],
//   }
// })
//       }
